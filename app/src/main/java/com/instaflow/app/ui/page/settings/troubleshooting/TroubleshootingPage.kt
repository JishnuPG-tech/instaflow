package com.instaflow.app.ui.page.settings.troubleshooting
...
import com.instaflow.app.ui.page.settings.BasePreferencePage
import com.instaflow.app.ui.page.settings.general.YtdlpUpdateChannelDialog
        ...
        LazyColumn(contentPadding = it) {
            item {
                OutlinedCard(modifier = Modifier.padding(16.dp)) {
                    ...
                    val knownIssueUrlInstaFlow = "https://github.com/JishnuPG-tech/instaflow/issues"
                    PreferenceItem(
                        title = "Report an Issue",
                        description = "Report bugs or suggest features on GitHub",
                        icon = Icons.AutoMirrored.Outlined.OpenInNew,
                        onClick = { uriHandler.openUri(knownIssueUrlInstaFlow) },
                    )
            ...
            item {
                PreferenceItem(
                    ...
                    onClick = { onNavigateTo(Route.ACCOUNT_PROFILE) },
                )
            }
