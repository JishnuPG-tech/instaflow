        ...
        modifier = Modifier
            ...
            if (isCarousel && items.isNotEmpty()) {
                ...
                Button(
                    ...
                    Text("Download Selected (${selectedIndices.size})", fontWeight = FontWeight.Bold)
                }

            } else {
                // Single Media Format Selection
                LazyColumn(
                            ...
                            Card(
                                ...
                                Row(
                                    ...
                                    Column(modifier = Modifier.weight(1f)) {
                                        ...
                                        } else if (urlType == InstagramUrlType.PROFILE_PIC || (urlType == InstagramUrlType.POST && !format.isAudioOnly)) {
                                            Text(
                                                text = "—",
                                                style = MaterialTheme.typography.labelMedium,
                                                color = MaterialTheme.colorScheme.onSurfaceVariant
