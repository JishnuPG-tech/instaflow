package com.instaflow.app.ui.page.settings.about
...
import com.instaflow.app.App.Companion.packageInfo
...
import com.instaflow.app.util.AUTO_UPDATE
import com.instaflow.app.util.PreferenceUtil
import com.instaflow.app.util.ToastUtil

private const val releaseURL = "https://github.com/JishnuPG-tech/instaflow/releases"
private const val repoUrl = "https://github.com/JishnuPG-tech/instaflow"
const val weblate = "https://hosted.weblate.org/"
const val YtdlpRepository = "https://github.com/yt-dlp/yt-dlp"
private const val githubIssueUrl = "https://github.com/JishnuPG-tech/instaflow/issues"
private const val githubSponsor = "https://github.com/JishnuPG-tech"
...
fun AutoUpdateUnavailableDialog(onDismissRequest: () -> Unit = {}) {
    ...
    val text = stringResource(id = R.string.auto_update_disabled_msg, "non-official", hyperLinkText)
    ...
    val annotatedString = buildAnnotatedString {
        ...
        addUrlAnnotation(
            UrlAnnotation("https://github.com/JishnuPG-tech/instaflow/releases/latest"),
            start = startIndex,
            end = endIndex,
        )
        addStyle(
