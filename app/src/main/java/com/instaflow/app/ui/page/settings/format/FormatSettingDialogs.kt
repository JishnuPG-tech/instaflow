...
import com.instaflow.app.ui.common.stringState
import com.instaflow.app.ui.component.ConfirmButton
import com.instaflow.app.ui.component.DialogSingleChoiceItem
import com.instaflow.app.ui.component.DialogSingleChoiceItemVariant
import com.instaflow.app.ui.component.DialogSubtitle
import com.instaflow.app.ui.component.DialogSwitchItem
import com.instaflow.app.ui.component.DismissButton
import com.instaflow.app.ui.component.OutlinedButtonChip
import com.instaflow.app.ui.component.PreferenceSubtitle
import com.instaflow.app.ui.component.InstaFlowDialog
import com.instaflow.app.ui.component.InstaFlowTextField
...
import com.instaflow.app.util.CONVERT_SUBTITLE
import com.instaflow.app.util.CONVERT_VTT
import com.instaflow.app.util.DEFAULT
import com.instaflow.app.util.DownloadUtil
import com.instaflow.app.util.FORMAT_COMPATIBILITY
import com.instaflow.app.util.FORMAT_QUALITY
import com.instaflow.app.util.M4A
import com.instaflow.app.util.NOT_CONVERT
import com.instaflow.app.util.NOT_SPECIFIED
import com.instaflow.app.util.OPUS
...
import com.instaflow.app.util.ULTRA_LOW
import com.instaflow.app.util.getStringDefault
        ...
        icon = {
            Surface(
                ...
                Box(contentAlignment = Alignment.Center) {
                    Text("HQ", style = MaterialTheme.typography.labelSmall, fontWeight = FontWeight.Black)
                }
            }
        },
        title = { Text(text = "Video quality", fontWeight = FontWeight.Bold) },
        dismissButton = {
            ...
            Column {
                ...
                LazyColumn(modifier = Modifier.heightIn(max = 400.dp)) {
                        ...
                        for (i in RES_HIGHEST..RES_LOWEST) {
                            Row(
                                ...
                                Text(
                                    ...
                                    fontWeight = if (videoResolution == i) FontWeight.Bold else FontWeight.Normal
                                )
                            }
                        }
                    }
                    ...
                    item {
                        ...
                        DialogSubtitle(text = "Video format preference")
                    }
