...
interface VideoInfoDao {
    ...
    @Query("select * from AccountProfile") fun getAccountProfileFlow(): Flow<List<AccountProfile>>
    ...
    @Query("select * from AccountProfile where id=:id")
    suspend fun getAccountById(id: Int): AccountProfile?

    @Update suspend fun updateAccountProfile(accountProfile: AccountProfile)
