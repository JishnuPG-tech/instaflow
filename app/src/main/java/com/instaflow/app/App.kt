...
import com.instaflow.app.download.DownloaderV2Impl
import com.instaflow.app.ui.page.download.HomePageViewModel
import com.instaflow.app.ui.page.downloadv2.configure.DownloadDialogViewModel
import com.instaflow.app.ui.page.settings.directory.Directory
import com.instaflow.app.ui.page.settings.network.AccountsViewModel
import com.instaflow.app.ui.page.videolist.VideoListViewModel
import com.instaflow.app.util.AUDIO_DIRECTORY
import com.instaflow.app.util.COMMAND_DIRECTORY
import com.instaflow.app.util.DownloadUtil
import com.instaflow.app.util.FileUtil
import com.instaflow.app.util.FileUtil.createEmptyFile
...
import com.instaflow.app.util.FileUtil.getExternalPrivateDownloadDirectory
...
import com.instaflow.app.util.SDCARD_URI
import com.instaflow.app.util.UpdateUtil
import com.instaflow.app.util.VIDEO_DIRECTORY
import com.instaflow.app.util.YT_DLP_VERSION
...
class App : Application() {
    override fun onCreate() {
        ...
        videoDownloadDir = VIDEO_DIRECTORY.getString(getExternalDownloadDirectory().absolutePath).replace("/Seal", "/InstaFlow")
        if (videoDownloadDir.contains("/InstaFlow") && !VIDEO_DIRECTORY.getString().contains("/InstaFlow")) {
            VIDEO_DIRECTORY.updateString(videoDownloadDir)
        }

        audioDownloadDir = AUDIO_DIRECTORY.getString(File(videoDownloadDir, "Audio").absolutePath).replace("/Seal", "/InstaFlow")
        if (audioDownloadDir.contains("/InstaFlow") && !AUDIO_DIRECTORY.getString().contains("/InstaFlow")) {
    ...
    companion object {
        ...
        fun getVersionReport(): String {
            ...
            return StringBuilder()
                ...
                .append("Engine version: ${YT_DLP_VERSION.getString()}\n")
                .toString()
        }
