...
# Robust sys.path & sys.modules alias to guarantee 'backend.app' imports work in all container environments
_file_path = Path(__file__).resolve()
_app_dir = _file_path.parent.parent # /backend
_root_dir = _app_dir.parent # root

for p in [str(_root_dir), str(_app_dir), str(_file_path.parent)]:
